# Playlist Research - Michael Buchanan's "Research" Playlist (2026-09-07 Evening Run)

> **Run note:** the playlist turned over 100% between the noon check (~12:45) and this run (~17:50) — all 10 videos are new, none survive from the morning snapshot. Full transcripts for all 10 (including a 425K-char, ~5-hour Fortnite compilation) via kome.ai/yt-dlp fallbacks.

**Videos found:** 10 · **Transcripts:** 10/10
...
- **Replication steps:** (1) pick a niche with fragmented public data + passionate users; (2) AI-build the app shell fast — the shell is not the product; (3) build the proprietary data layer competitors can't copy (his phone calls); (4) undercut the clone-tier price ($30 vs $120-200/yr); (5) seed UGC so the product improves itself; (6) distribute where the niche physically gathers; (7) watch trials as the leading indicator.
- **Automation potential:** 5/10 — vibe coding automates the shell; the moat (data acquisition calls, UGC moderation, community presence) is deliberately manual.
- **Quality:** 9/10 — strongest receipts in the batch: live RevenueCat dashboard figures, named competitors tested on camera. Self-reported but internally consistent.
...
- **Replication steps:** (1) Codex desktop → GPT-6 Astra, medium effort; (2) install Higgsfield plugin; (3) drop in the skill zip; (4) paste product URL → automated brand research brief; (5) feed 1-3 reference UGC videos; (6) prompt for adapted scripts/shot plans; (7) generate end-to-end videos; (8) iterate in-chat.
- **Automation potential:** 8/10 — the entire pipeline is agentic in one chat; taste and selling stay human.
- **Quality:** 4/10 — workflow genuinely demonstrated step-by-step on screen; effectiveness purely asserted. The street-interview demo shows fully synthetic people giving fake opinions on a real product — presented as great, never disclosed as synthetic.
- **Verdict: Mixed**
...
- **Replication steps:** plainly — for the slot "system," the only replication is gamble; slots are per-spin RNG with a fixed house edge and no bet sequence changes expected value. Replicable is the format: daily play + transparent bankroll + casino partnership (casinos fund creators who deliver visitors) + memberships + giveaways. One real fact: paytable RTP improves with denomination (2¢→5¢ raised the mini 2.5x for ~25% more bet) — known paytable math, not an edge.
- **Automation potential:** 2/10 — live personality content doesn't automate.
- **Quality:** 6/10 — honest and self-aware (discloses the casino gift, debunks its own hook), but the clickbait framing will still mislead some viewers.
...
- **Replication steps:** best of the ten per receipts: #7 hyper-specific digital asset packs (specificity = less competition, higher conversion) and #4 personalized kids storybooks ($30-40, 30-45 min/book). #6 (Amazon on-listing video commissions) is the freshest mechanic — buy only products you'd review honestly.
- **Automation potential:** 8/10 — everything deliberately near-fully AI-generated; that same automation is why each niche is commoditizing fast.
- **Quality:** 5/10 — some real screenshots, but headline numbers are estimator math, and "not many people are using ChatGPT this way" is false — every one of these niches is already crowded with AI sellers.
- **Verdict: Mixed**
...
- **Replication steps:** genuinely-$0 starts: Printify Pop-Up POD and the Fiverr research gig. Her monetization-verification trick is the real asset: check a channel for memberships/Super Thanks — platform-verified proof of monetization, no screenshots needed. Spread generation across multiple free AI quotas for zero-cost output.
- **Automation potential:** 7/10 — generation/VO/subtitles/research automated; Etsy ops, Fiverr delivery, teaching, posting cadence manual.
- **Quality:** 6/10 — best credibility method in the batch (platform-verified signals), honest that "free" has exceptions ($15 Etsy fee, POD float, Canva trial, 50 Flow credits/day) — but every income figure is still estimator math or someone else's anecdote.
- **Verdict: Mixed**
...
- **Replication steps:** if serious about micro-drama, ignore these numbers: study the format (60-90s episodes, cliffhanger structure), cost out a pilot season (the video's cost omission is the tell), benchmark against established vertical-drama apps' official creator programs, and demand written payout terms before licensing anything. The "6 streams" framing survives as a licensing-deal negotiation checklist.
- **Automation potential:** 4/10 — scripting/VO/editing AI-assistable; production and marketing burn real money.
- **Quality:** 3/10 — single-source vendor data with unfalsifiably wide ranges; the platform's own video has 305 views — no visible evidence the advertised economy exists.
...
- **Replication steps:** audit which functions your dominant marketplace actually performs vs. what you do; add a direct channel with customer-data access alongside it; start the email list before you need it; watch marketplace-share trend as the trigger to build the off-ramp.
- **Automation potential:** 5/10 — repurposing/email/storefront automate; the thesis rests on manually earned trust.
- **Quality:** 6/10 — infrastructure claims are checkable and real (Lulu Direct, Share & Sell, D2D's own advice against stacking print channels); the two key stats are unnamed surveys; 2023 speculation treated as present fact; she sells the alternative she's advocating.
...
- **Replication steps:** the 7 tips judged on substance — **keepers: #2** plan-high/execute-low reasoning-tier cost discipline; **#5** the second-brain ticket loop (high-tier dumps ideas/tickets into Notion/Linear, low-tier loops through them — a real token-economy pattern); **#6** a dedicated always-on remote build/test box. **Overstated: #3** delete your AGENTS.md/skills (context bloat is real; wholesale deletion is untested — A/B first). **Weakest: #7** "ask instead of prompt" — abdicating direction dressed as technique.
- **Automation potential:** 6/10 — the tips are literally about delegating computer work; the channel itself is a manual talking head.
- **Quality:** 4/10 — zero receipts on the central claim; cherry-picked demos; partial credit for three genuinely usable workflow tips.
- **Verdict: Mixed** — skip the AGI narrative, steal tips 2/5/6.
...
- **Replication steps:** UEFN → template/clone-style gameplay (1v1, box PvP, tycoon) → design for 25-40+ min average sessions (discovery ranks on retention) → AI thumbnail pipeline (Gemini "Fortnite style, arms crossed, white background" → Photopea brighten/sharpen/vignette — brightness wins on tiny tiles) → publish timed to season/update days → track on Fortnite.gg → iterate. The cheap experiment: one template map + AI thumbnail + season-day launch, measure engaged minutes, never buy the mentorship.
- **Automation potential:** 6/10 — the thumbnail pipeline is ~90% automatable and the recipe is given verbatim (transferable to any game-facing content); retention-winning design is genuine creative labor, and AI shovelware demonstrably fails to hold engagement (his own footage proves it).
- **Quality:** 5/10 — real current workflow information buried in rambling, self-aggrandizing delivery with outlier revenue and near-zero success-rate math; ~1K views on a 5-hour "FULL GUIDE" suggests the audience is mostly other hopefuls.
- **Verdict: Mixed** — the rail (engagement payouts, $0 tooling) is real; this course funnel isn't the reason to care.
...
- **Replication steps:** the pattern, not this paper: (1) get inside first — the demonstrated path is becoming indispensable to the outlet (10+ years freelancing → editor) so you're positioned when an absentee owner wants out; (2) assemble a small owner group deliberately mixing content and revenue; (3) target alt-weeklies/weeklies in growing markets held by chains or retiring founders — small-check deals with brand equity intact; (4) strip to owner-operator headcount; (5) monetize beyond banners: custom ads, events/listings, brand collabs; (6) sell the human-local moat to both readers and advertisers; (7) diligence what the interview skips: circulation/reader age, advertiser churn, print contracts, 3 years of P&L before valuing "iconic."
- **Automation potential:** 2/10 — the moat is deliberately human; only back-office automates.
- **Quality:** 6/10 — first-party credibility (he actually owns it, names names) but zero quantitative content. High trust, low data — the exact inverse of the Shortfundly brochure, and more valuable for it.
- **Verdict: Mixed**
- **Key actions:** scan for distressed legacy-media patterns in growing markets; lead with the revenue-side partner; "curated-human-local" is a sellable pitch in an AI-slop market; pull prior-owner filings for the economics this interview omits.
- **Red flags:** no financials from an owner interview; "got lucky" survivorship framing; promo-flavored podcast, hard questions never asked; print-cost and audience-age exposure unaddressed.

## Final Ranking (by automation potential)

1. **AI UGC ad studio pipeline (Miko) — 8/10** (Mixed — the pipeline is real, the economics unproven)
2. **10 AI money methods (Mayo) — 8/10** (Mixed — best items: asset packs, storybooks)
3. **$0-start AI hustles (Wholesale Ted) — 7/10** (Mixed — best verification method in the batch)
4. **Astra workflow tips (Alex Finn) — 6/10** (Mixed — keepers: tiered reasoning, ticket loop, test box)
5. **UEFN Fortnite creator path (Davhy Davis) — 6/10** (Mixed — real rail, guru funnel)
6. **Niche app with data moat (Casey) — 5/10** (Worth Trying — best receipts, quality 9/10)
7. **Direct-sales book stack (Guerrilla Publisher) — 5/10** (Worth Trying for marketplace sellers)
8. **Micro-drama OTT licensing (Shortfundly) — 4/10** (Skip — vendor brochure)
9. **Casino creator economy (Desert Degens) — 2/10** (Skip — entertainment; casino-comp model noted)
10. **Local media buyout (Tommy's Toolbox) — 2/10** (Mixed — new acquisitions variant, worth a dedicated dig)

## Cross-Video Synthesis

**Three threads across ten videos.** (1) **Production cost has collapsed; moats haven't.** Batch A's throughline: vibe-coded clones ship fast and still lose to proprietary data (Casey's ranger-district phone calls), distribution, and verified proof. The GPT-6 Astra wave (3 titles) is the same story at the tool layer — every demonstration is procedural, every effectiveness claim is asserted, and the only verified AI-product profits in the batch belong to the creators selling the tutorials. (2) **Own the relationship, not the platform.** The Guerrilla Publisher (authors vs Amazon), the Creative Loafing buyout (locals vs extractive chains), and even Shortfundly's pitch all argue the same structure from different directions: whoever creates demand should own the customer record and the transaction. The employee-group buyout of distressed legacy media is a genuine **new variant of the acquisitions theme** worth a dedicated dig — small checks, brand equity, ad-book transferability. (3) **Verification techniques are becoming the content.** Wholesale Ted's YPP-membership check and Casey's live dashboard walkthrough are themselves reusable audit methods — use them on every future batch. Against the known-theme list: ~7 of 10 are re-skins (Etsy/POD/KDP, faceless channels, micro-SaaS, creator funnels, courses). New or sharpened: **AI UGC ad studios as a service**, **Amazon on-listing video commissions**, **synthetic fashion-model affiliate accounts**, **UEFN engagement-payout mechanics** (engaged-minute rates + season-timing), the **zero-cost AI thumbnail pipeline**, the **casino-comp-for-creator-traffic sponsorship model**, and the **local-media employee buyout**. Numbers-to-credibility inversion held all night: the vendor with the most dollar figures was least verifiable; the actual owner gave none.
